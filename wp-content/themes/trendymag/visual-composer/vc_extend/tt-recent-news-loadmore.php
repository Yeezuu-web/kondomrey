...
if (function_exists('vc_map')) :
	...
	// Latest blog element
	vc_map( array(
		'name'        => esc_html__( 'Recent News with loadmore', 'trendymag'),
		'base'        => 'tt_recent_news_loadmore',
		'icon'        => 'fa fa-qrcode',
		'category'    => esc_html__( 'TT Elements', 'trendymag'),
		'description' => esc_html__( 'Show off recent news with loadmore', 'trendymag'),
		'params'      => array(
			...
			array(
                'type' 			=> 'textfield',
                'heading' 		=> esc_html__( 'Loadmore Text', 'trendymag' ),
                'param_name' 	=> 'loadmore_text',
                'value' 		=> esc_html__( 'Load More', 'trendymag' )
            ),
	...
	if ( class_exists( 'WPBakeryShortCode' ) ) {
		class WPBakeryShortCode_TT_Recent_News_Loadmore extends WPBakeryShortCode {
		}
	}
endif;