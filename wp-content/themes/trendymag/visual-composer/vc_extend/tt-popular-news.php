...
if (function_exists('vc_map')) :
	vc_map( array(
		'name'        => esc_html__( 'Popular News', 'trendymag'),
		'base'        => 'tt_popular_news',
		'icon'        => 'fa fa-qrcode',
		'category'    => esc_html__( 'TT Elements', 'trendymag'),
		'description' => esc_html__( 'Show off popular news', 'trendymag'),
		'params'      => array(

			array(
				'type'        	=> 'dropdown',
				'heading'     	=> esc_html__( 'Post options', 'trendymag'),
				'param_name'  	=> 'post_options',
				'value' 		=> array(
					esc_html__('Todays popular post', 'trendymag') => 'todays-popular',
					esc_html__('Weekly popular post', 'trendymag') => 'weekly-popular',
					esc_html__('Monthly popular post', 'trendymag') => 'monthly-popular',
					esc_html__('All time popular post', 'trendymag') => 'all-time-popular'
				),
				'admin_label' 	=> true,
				'description' 	=> esc_html__( 'Select range of popular post', 'trendymag')
			),
	...
	if ( class_exists( 'WPBakeryShortCode' ) ) {
		class WPBakeryShortCode_TT_Popular_News extends WPBakeryShortCode {
		}
	}
endif;