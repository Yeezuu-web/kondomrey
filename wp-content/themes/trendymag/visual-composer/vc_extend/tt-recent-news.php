...
if (function_exists('vc_map')) :
	...
	// Latest blog element
	vc_map( array(
		'name'        => esc_html__( 'Recent News', 'trendymag'),
		'base'        => 'tt_recent_news',
		'icon'        => 'fa fa-qrcode',
		'category'    => esc_html__( 'TT Elements', 'trendymag'),
		'description' => esc_html__( 'Show off recent news', 'trendymag'),
		'params'      => array(
	...
	if ( class_exists( 'WPBakeryShortCode' ) ) {
		class WPBakeryShortCode_TT_Recent_News extends WPBakeryShortCode {
		}
	}
endif;