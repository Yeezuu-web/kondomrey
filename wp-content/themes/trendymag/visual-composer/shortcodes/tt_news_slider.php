<?php 
    ...
    if ($tt_atts['image_size'] == 'trendymag-recent-post') :
        $featured_image = 'trendymag-recent-post';
    elseif($tt_atts['image_size'] == 'trendymag-two-third') :
        $featured_image = 'trendymag-two-third';
    elseif($tt_atts['image_size'] == 'trendymag-news-cover-thumbnail') :
        $featured_image = 'trendymag-news-cover-thumbnail';
    endif;
    ...
    <div class="post-wrapper style-two <?php echo esc_attr($tt_atts['el_class'].' '.$css_class); ?>">
            ...
            <ul class="slides">
                ...
                <?php if ( $query->have_posts() ) : ?>
                    <?php while ( $query->have_posts() ) : $query->the_post(); 
                        ...
                        <li>
                            <div <?php post_class('recent-news'); ?> style="<?php echo esc_attr($post_height);?>">
